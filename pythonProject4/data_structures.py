...
# Sözlük (dictionary)
# Sözlükler "key" ve "value"-dan oluşur. Onları ayırmak için : kullanılır.
x = {"name": "Peter", "Age": 36}
type(x)
...
set2 - set1
########################
# symmetric_difference (): İki kümede de birbirilerine göre olmayanlar
########################
...
########################
# issuperset (): Bir küme diğer kümeni kapsıyor mu?
########################
